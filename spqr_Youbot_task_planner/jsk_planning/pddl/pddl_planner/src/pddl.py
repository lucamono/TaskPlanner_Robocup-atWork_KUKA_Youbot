...
class PDDLPlannerActionServer(object):
    ...
    def call_pddl_planner(self, problem, domain):
        ...
        # ffha
            ...
            path_name = rospack.get_path('pddl_planner') + '/Robocup_task/plan'
            #path_name = "/home/giulio/catkin_SPQR/src/SPQR-Work/jsk_planning/pddl/pddl_planner/Robocup_task/plan"
